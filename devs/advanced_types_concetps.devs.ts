...
//=========function overloads 25-29,these are ways to tell the function what type is to be expected on return based on the argument type.
...
//function overloads ---line 25-29
const result = add('Bradley', 2);
result.split(' ');

//optional chaining
//if this was fetched and ts didn't know weather job exists or not it wouldn't error.
...
//Nullish Coalescing = ?? IF NULL OR UNDEFINED USE DEFAULT OTHERWISE WE CAN USE SOMETHING LIKE AN EMPTY STRING even thought the output is nothing
